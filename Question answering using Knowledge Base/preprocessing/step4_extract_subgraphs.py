...
question_json = "scratch/complexwebq_processed.json"
output_json = "complexwebq_subgraphs.json"

# fixed files
subgraph_dir = "freebase_2hops/stagg.neighborhoods/"
question_seeds = "scratch/stagg_linked_questions_complexwebQ.txt"
question_emb = "scratch/complexwebq_embeddings.pkl"
...
def _read_facts(fact_file, relation_embeddings, question_embedding,
    ...
    seeds_found = set()
    with open(fact_file, encoding="utf8") as f:
        entity_map = {}
        relation_map = {}
...
if __name__ == "__main__":
    ...
    questions = json.load(open(question_json, encoding="utf8"))
    ...
    with open(output_json, "w") as fo:
        ...
        for question in tqdm(questions):
            ...
            fact_file = os.path.join(
                subgraph_dir, question["WebQID"] + ".nxhd")
